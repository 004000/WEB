...
## ניקוי אוטומטי וגיבוי הודעות ישנות
כדי למנוע התמלאות מסד הנתונים (Redis/kvrocks), המערכת יכולה לגבות ולמחוק לצמיתות הודעות ישנות מעל תקופה מוגדרת.
המנגנון רץ אוטומטית אחת ליום, וניתן גם להריץ אותו ידנית מפאנל הניהול, בלשונית "אחסון וגיבוי".

**חשוב:** המחיקה הלצמיתות מתבצעת רק אם הוגדר גיבוי תקין ל-GitHub. אם הגיבוי לא מוגדר, המערכת תמשיך לפעול כרגיל
(מחיקה רגילה של הודעות דרך הממשק תישאר "מחיקה רכה" בלבד, ללא השפעה על נפח האחסון).
